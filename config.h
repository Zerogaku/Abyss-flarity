...
// For italics.
char *font_italic = "JetBrainsMono Nerd Font:style=Italic:size=12";

// For boldness italic.
char *font_bold = "JetBrainsMono Nerd Font:style=Bold Italic:size=12";

// For boldness.
char *font_roman = "JetBrainsMono Nerd Font:style=ExtraBold:size=12";
...
static Rune stcursor = 0x2603; /* a main (U+2603) */
